...
```{r rest-pairwise-5.2, eval = FALSE}
...
### Genus [combined]
```{r ldh-pairwise-genus, eval= FALSE}
...
```{r Q10exploratory plot, eval=TRUE, echo=FALSE}
ggplot(ldh.means.temp.df, aes(x=temperature, y=Q10, color=species)) + 
  geom_line(size=2) + 
  geom_point(shape = 15, color="red", size = 3) +
  xlab("") + ylab(expression("Q10"))+
...
```{r cs-save-file-1, echo=FALSE, hide=TRUE, eval = TRUE}
...
```{r cs-pairwise-genus2, eval=TRUE}
...
```{r CsQ10exploratory plot, eval=TRUE, echo=FALSE}
ggplot(cs.means.temp.df, aes(x=temperature, y=Q10, color=species)) + 
  geom_line(size=2) + 
  geom_point(shape = 15, color="red", size = 3) +
  xlab("") + ylab(expression("Q10"))+
  scale_x_continuous(limits = c(19, 52), 
...
```{r lc-model-re-re-validatiaon-1, warning=FALSE, message=FALSE, fig.width=8, fig.height= 6, eval=FALSE, echo=FALSE}
...
## Figure 1
```{r Figure-1, eval=TRUE, echo=TRUE, fig.width=8, fig.height=10}
#--- LDH plot ---# 
ldh.emm <- emmeans(ldh.sqrt.model.1.p2, ~temperature|LATITUDE|LATIN_GENUS, 
                   at = list(temperature = seq(from =10, to =50, by =.1)), 
                   type = "response") 
...
ldh.plot <- ggplot(ldh.emm.df, aes(y=response, x=temperature, linetype=species, color = species, fill=species))+
  ...
  theme(legend.position = "none", 
        ...
        plot.margin=margin(.5,3,.5,.5, unit="cm"))
...
```{r SFigure-1, eval=TRUE, echo=TRUE, fig.width=8, fig.height=10}
#--- LDH plot ---#
...
#--- LDH:CS ---# 
ldhcs.temp.emm <- emmeans(lc.model.1.p2.gamma.log, ~temperature, 
                   at = list(temperature = seq(from =10, to =50, by =.1)), 
                   type = "response") %>% as.data.frame()

ldhcs.temp.df <- ldhcs.temp.emm %>% as.data.frame()

ldhcs.temp.obs <- lc.data %>% 
  mutate(Pred=predict(lc.model.1.p2.gamma.log, re.form=NA, type="response"),
         Resid = residuals(lc.model.1.p2.gamma.log),
         Fit = Pred + Resid)

ldhcs.temp.plot <- ggplot(ldhcs.temp.df, aes(y=response, x=temperature))+
  geom_jitter(data=ldhcs.temp.obs, 
              aes(y=Fit, fill="black"), 
              width=0.05, 
              alpha = 0.3, 
              size = 2) +
  ...
  theme_classic() + 
  ylab(expression("LDH:CS ratio")) + 
  xlab("TEMPERATURE (\u00B0C)")+
  theme(legend.position = "none", 
        axis.title = element_text(size =12), 
        axis.text = element_text(size=10)); ldhcs.temp.plot

temp.plot <- ggarrange(cs.temp.plot, ldh.temp.plot, ldhcs.temp.plot,
         nrow = 3, 
         ncol= 1, 
          align = "hv", 
         labels = c("A","B","C"), 
...
#(file="./02.Figures/SFigure1/SFigure1_temp_plot.svg",  plot=temp.plot, width=12, height=10, units = "in", dpi=300) 
#ggsave(file="./02.Figures/SFigure1/SFigure1_temp_plot2.svg", plot=temp.plot, width=10, height=8, units = "in", dpi=300)
#ggsave(file="./02.Figures/SFigure1/SFigure1_temp_plot3.svg", plot=temp.plot, width=8, height=5, units = "in", dpi=300)
#ggsave(file="./02.Figures/SFigure1/SFigure1_temp_plot.pdf",  plot=temp.plot, width=12, height=10, units = "in", dpi=300)
#ggsave(file="./02.Figures/SFigure1/SFigure1_temp_plot2.pdf", plot=temp.plot, width=10, height=8, units = "in", dpi=300)
#ggsave(file="./02.Figures/SFigure1/SFigure1_temp_plot3.pdf", plot=cs.genus.plot, width=8, height=5, units = "in", dpi=300)
``` 

## Supplemental figure 2

```{r SFigure-2, eval=TRUE, echo=TRUE, fig.width=8, fig.height=10}
...
cs.genus.plot <- ggplot(cs.genus.emm, aes(y=response, x=temperature, linetype=LATIN_GENUS, color = LATIN_GENUS, fill=LATIN_GENUS))+
  ...
  scale_fill_manual(values=c("black","gray60"), 
   ...
   theme(legend.position = c(0.2,0.85), 
        ...
        axis.text = element_text(size=14)); cs.genus.plot



#ggsave(file="./02.Figures/SFigure2/Figure2_cs_genus_plot.svg",  plot=cs.genus.plot, width=15.5, height=8.5, units = "in", dpi=300) 
#ggsave(file="./02.Figures/SFigure2/Figure2_cs_genus_plot2.svg", plot=cs.genus.plot, width=12, height=7, units = "in", dpi=300)
#ggsave(file="./02.Figures/SFigure2/Figure2_cs_genus_plot3.svg", plot=cs.genus.plot, width=8, height=5, units = "in", dpi=300)
#ggsave(file="./02.Figures/SFigure2/Figure2_cs_genus_plot.pdf",  plot=cs.genus.plot, width=15.5, height=8.5, units = "in", dpi=300)
#ggsave(file="./02.Figures/SFigure2/Figure2_cs_genus_plot2.pdf", plot=cs.genus.plot, width=12, height=7, units = "in", dpi=300)
#ggsave(file="./02.Figures/SFigure2/Figure2_cs_genus_plot3.pdf", plot=cs.genus.plot, width=8, height=5, units = "in", dpi=300)
```




## Supplemental Figure 2 (old)

```{r SFigure-NA, eval=FALSE, echo=FALSE}
